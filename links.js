...
async function send_link(link, password = ''){
    ...
    await bot.pinChatMessage(target_group, sended_message.message_id, disable_notification);
...
// Friday
schedule.scheduleJob('25 9 * * 5', () => send_link(config.chemistry));
